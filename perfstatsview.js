...
export default function () {
    const baseUrl = 'https://stg-api-gw.pillar-app.com/trainer/private/api/v1/performance/stats/overview';
    const headersData = {
        headers: {
    ...
    if (check(response, {
        ...
        check(response, {
            ...
            'Weekly Distance is': (r) => r.json().data.weekly_distance.includes("0.0 km")
        });
    }
