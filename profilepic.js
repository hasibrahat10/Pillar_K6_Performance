...
export default function () {
    const baseUrl = 'https://stg-api-gw.pillar-app.com/core/private/api/v1/user/profile/picture';
    ...
    if (check(response, { 'Status & Error is': (r) => r.status == 200 && r.error == false })) {
        check(response, {
            ...
            'placeholder image is exist': (r) => r.json().data.is_placeholder_image == true
        });
    }
