...
export default function () {
    const baseUrl = 'https://stg-api-gw.pillar-app.com/trainer/private/api/v1/day/today/focus';
    ...
    if (check(response, { 'Status & Error is': (r) => r.status == 200 && r.error == false })) {
        check(response, {
            ...
            'User is Hasib to message that': (r) => r.json().data.message.includes('Hi Hasib ')
        });
    }
