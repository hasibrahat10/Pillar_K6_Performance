...
export default function () {
    const baseUrl = 'https://stg-api-gw.pillar-app.com/trainer/private/api/v1/performance/session-difficulty/overview';
    const headersData = {
        headers: {
    ...
    if (check(response, {
        ...
        check(response, {
            ...
            'Difficulty level remarks is': (r) => r.json().data.difficulty_level_remarks.includes("Your difficulty not increased recently, ")
        });
    }
